...
# python create_training_images.py
# --image berea.tif --name berea --edgelength 64 --stride 32 --target_dir berea_ti
...
edge_length = opt.edgelength #image dimensions图像尺寸
stride = opt.stride #stride at which images are extracted提取图像的步幅
